...
class TestPermissionError(unittest.TestCase):
    ...
    def test_no_error_during_sync(self, mocked_get_row_iterators, mocked_stats, mocked_logger, mocked_connect):
        ...
        rows_synced = sync.sync_file(conn, {"filepath": "/root_dir/file.csv.gz", "last_modified": "2020-01-01"}, singer.CatalogEntry(tap_stream_id="test", schema=singer.Schema(), metadata=[]), {"key_properties": ["id"], "delimiter": ","})
